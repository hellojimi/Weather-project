...
public class DiaryController {
    ...
    List<Diary> readDiaries(
            ...
            @Parameter(description = "조회할 기간의 첫번째 날", example = "2024-01-01") LocalDate startDate,
            @RequestParam
            @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
            @Parameter(description = "조회할 기간의 마지막 날", example = "2024-01-01") LocalDate endDate) {
    ...
    @Operation(summary = "선택한 날짜의 일기를 삭제")
